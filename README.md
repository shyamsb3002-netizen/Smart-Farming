...
## DATA SOURCE 📊
- [Crop recommendation dataset ](https://www.kaggle.com/datasets/shyams2003/crop-prediction-dataset) (custom built dataset)
...
## Contributors:
-[Shyam.S](www.linkedin.com/in/shyam-s-se)


## Home Page of our WebApplication
![Home Page of our WebApplication](https://github.com/shyamsb3002-netizen/precision-agriculture-using-machine-learning/blob/main/Project-docs/App-snaps/Home.png)
